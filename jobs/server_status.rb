...
# servers = [{name: 'Magic', url: 'http://www.alexthegreat.ca', method: 'http'},
#     {name: 'Home (virtualized)', url: 'http://octranspo.org', method: 'http'},
#     {name: 'ATAM', url: 'http://www.atam.ca', method: 'http'},
#     {name: 'CPS', url: 'http://www.coldplaysucks.com', method: 'http'}]

servers = [{name: 'server1', url: 'http://www.alexthegreat.ca', method: 'http'},
    {name: 'server2', url: 'http://octranspo.org', method: 'http'},
    {name: 'server3', url: 'http://atam.ca', method: 'http'}]
